...
class MoneyServiceAdapterTest {
    ...
    void requestMoneyIncrease() {
        IncreaseMoneyResponse increaseMoneyResponse = moneyServiceAdapter.requestMoneyIncrease(1L, 1000L);
        assertThat(increaseMoneyResponse.getMembershipId()).isEqualTo(1L);
        assertThat(increaseMoneyResponse.getAmount()).isEqualTo(1000L);
